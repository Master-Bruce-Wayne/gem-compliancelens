...
class BidApplication(Base):
    ...
    status = Column(Enum('draft', 'submitted', 'under_evaluation', 'clarification_requested', 'qualified', 'disqualified', 'withdrawn', name='bid_status_enum'), default='draft', nullable=False)
