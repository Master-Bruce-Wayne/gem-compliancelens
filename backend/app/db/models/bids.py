...
class BidApplication(Base):
    ...
    status = Column(Enum('draft', 'submitted', 'under_evaluation', 'clarification_requested', 'pending_approval', 'qualified', 'disqualified', 'withdrawn', 'access_pending', 'access_denied', name='bid_status_enum'), default='draft', nullable=False)
